...
%parameters
value_per_sheep       = 230;   % €
milk_loss_per_infected= 25;    % € 
vet_cost              = 100;   % € per farm
...
ylabel('Total Costs (€)');
title(sprintf('Saving: %.1f%% (%.2f €)',save_pct,Cost_b - Cost_e));
